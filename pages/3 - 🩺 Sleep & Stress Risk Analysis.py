...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const els = document.querySelectorAll('.fade-left, .fade-right');
...
with col_a:
    st.markdown(
        f"""
        <div class="insight-box fade-left" style="padding:20px; background-color:#f9f9f9; border-left: 5px solid #6C63FF; border-radius:10px; box-shadow: 2px 2px 8px rgba(0, 0, 0, 0.05);">
...
with col_b:
    st.markdown(
        f"""
        <div class="insight-box fade-right" style="padding:20px; background-color:white; border-left: 5px solid #20B2AA; border-radius:10px; box-shadow: 2px 2px 8px rgba(0, 0, 0, 0.05);">
