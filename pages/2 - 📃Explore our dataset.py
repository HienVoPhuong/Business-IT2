...
with st.sidebar:
    ...
    selected_nationalities = st.multiselect(
        "Select Nationality", nationality_options,
    ...
    selected_age_range = st.slider(
        "Select Age Range", min_value=default_age_range[0], max_value=default_age_range[1],
...
variables_description = [
    ...
    ("Sleep_Duration", "Average sleep hours per night."),
    ("Quality_of_Sleep", "Subjective sleep quality rating."),
    ...
    ("Daily_Steps", "Steps taken per day."),
    ("Sleep_Disorder", "Presence of sleep disorder."),
]
